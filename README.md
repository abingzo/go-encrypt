...
> 开发中，预计覆盖标准库大部分的摘要&加密算法，目前只完成了`Rsa&md5&sha1&sha256&sha512&Aes`的部分
...
```shell
[140 170 106 217 106 169 37 14 227 204 58 122 62 125 128 47]
[226 121 211 170 106 141 237 130 151 7 79 146 185 69 24 40]
[104 101 108 108 111 32 119 111 114 108 100]
[104 101 108 108 111 32 119 111 114 108 100 32 50]
```
